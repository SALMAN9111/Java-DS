...
//	@ManyToMany
	@OneToMany(cascade = CascadeType.PERSIST) // Only OneToMany has this cascade property
	private Collection<Vehicle> vehicle = new ArrayList<Vehicle>();

	// jontable joincolumns come here as table starts with this class name
...
//	@ElementCollection(fetch = FetchType.EAGER) --> This Annotation gives separate table for the field
